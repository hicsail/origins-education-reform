    ...
    with open(args.txt + '.txt', 'w') as txt_out:
        ...
        for i in range(len(year_list) - 1):
            ...
            for keyword in key_list:
                ...
                txt_out.write("Avg Sentiment score for this period: {0}"
                              .format(str(sent_avg[year_list[i]][keyword]) + "\n"))
                txt_out.write("Max Sentiment score for this period: {0}"
                              .format(str(sent_max[year_list[i]][keyword]) + "\n"))
                txt_out.write("Min Sentiment score for this period: {0}"
                              .format(str(sent_min[year_list[i]][keyword]) + "\n"))
                try:
